 ...
 *             50     : Applies with 400 steps/rev  (1/2th) microstepping - results in 0,02mm accuracy
 *            
 * 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 25, 25 } // ROSLAN: Tests show that 200 on X/Y is perfectly fine
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 10000 } // ROSLAN: Tests show that 500 on X/Y is perfectly fine (700 was a bit "sharp" ;) )
...
#define MANUAL_Z_HOME_POS 19.25
